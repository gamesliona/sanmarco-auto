...
Mobile-first poster generator for San Marco's 1080×1350 social post layout.
...
```powershell
git add .
git commit -m "Initial San Marco generator"
git branch -M main
...
The caption and interface use San Marco's yellow `#f5d548`. The image fades into the black caption area, matching the social post layout.
